...
using UltraliasApp;
using UltraliasAppTests.TestUtils;
using Xunit;

namespace UltraliasAppTests
{
    public class IntegrationTests
    {
        ...
        {
            // Arrange
            var expectedFilePath = Path.Combine(Path.GetTempPath(), "ultraliasfile.txt");
            DeleteFileIfExists(expectedFilePath);
            const string expectedFileContent = "This is a test file by ultralias.";
